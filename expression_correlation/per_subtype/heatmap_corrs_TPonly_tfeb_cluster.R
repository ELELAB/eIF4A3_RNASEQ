...
png('rows_ecdf_tfeb.png')
plot(ecdf(rows_full))
dev.off()

png('cols_ecdf_tfeb.png')
plot(ecdf(cols_full))
dev.off()
...
png('eigval_subtypes_0.2_tfeb.png')
fviz_eig(pcs)
dev.off()

png('proj12_subtypes_0.2_tfeb.png')
fviz_pca_ind(pcs, repel=TRUE, axes=c(1,2), labelsize=3)
dev.off()

png('proj13_subtypes_0.2_tfeb.png')
...
png("heatmap_correlations_0.05_0.2_TPonly_cluster_tfeb_euclidean.png", width=1000, height=800)
...
png("heatmap_correlations_0.05_0.2_TPonly_cluster_tfeb_euclidean_filt.png", width=1000, height=800)
Heatmap(t(corrs_m),
        na_col="grey", 
        col=colf,
        cluster_columns=F,
...
png("heatmap_correlations_0.05_0.2_TPonly_cluster_tfeb_pearson.png", width=1000, height=800)
hm = Heatmap(t(corrs_m2), 
        col=colf,
        na_col="grey", 
        cluster_columns=T,
...
png("heatmap_correlations_0.05_0.2_TPonly_cluster_tfeb_pearson_filt.png", width=1000, height=800)
Heatmap(t(corrs_m), 
        col=colf,
        na_col="grey", 
        cluster_columns=F,
...
png("heatmap_correlations_0.05_0.2_TPonly_cluster_tfeb_spearman.png", width=1000, height=800)
hm = Heatmap(t(corrs_m2), 
        col=colf,
        na_col="grey", 
        cluster_columns=T,
...
png("heatmap_correlations_0.05_0.2_TPonly_cluster_tfeb_spearman_filt.png", width=1000, height=800)
Heatmap(t(corrs_m), 
        col=colf,
        na_col="grey", 
        cluster_columns=F,
...
png('eigval_subtypes_0.15_tfeb.png')
fviz_eig(pcs)
dev.off()

png('proj12_subtypes_0.15_tfeb.png')
fviz_pca_ind(pcs, repel=TRUE, axes=c(1,2), labelsize=3)
dev.off()

png('proj13_subtypes_0.15_tfeb.png')
fviz_pca_ind(pcs, repel=TRUE, axes=c(1,3), labelsize=3)
dev.off()
...
png("heatmap_correlations_0.05_0.15_TPonly_cluster_tfeb_euclidean.png", width=1000, height=800)
hm = Heatmap(t(corrs_m2), 
             col=colf,
             cluster_columns=T,
             cluster_rows=T,
...
png("heatmap_correlations_0.05_0.15_TPonly_cluster_tfeb_euclidean_filt.png", width=1000, height=800)
Heatmap(t(corrs_m),
        na_col="grey", 
        col=colf,
        cluster_columns=F,
...
png("heatmap_correlations_0.05_0.15_TPonly_cluster_tfeb_pearson.png", width=1000, height=800)
hm = Heatmap(t(corrs_m2), 
             col=colf,
             na_col="grey", 
             cluster_columns=T,
...
png("heatmap_correlations_0.05_0.15_TPonly_cluster_tfeb_pearson_filt.png", width=1000, height=800)
Heatmap(t(corrs_m), 
        col=colf,
        na_col="grey", 
        cluster_columns=F,
...
png("heatmap_correlations_0.05_0.15_TPonly_cluster_tfeb_spearman.png", width=1000, height=800)
hm = Heatmap(t(corrs_m2), 
             col=colf,
             na_col="grey", 
             cluster_columns=T,
...
png("heatmap_correlations_0.05_0.15_TPonly_cluster_tfeb_spearman_filt.png", width=1000, height=800)
Heatmap(t(corrs_m), 
        col=colf,
        na_col="grey", 
        cluster_columns=F,
...
write.table(data.frame(euclidean=genes_0.05_0.15_TPonly_cluster_euclidean,
                     ...
                     'TFEB_genes_clustering_0.tfeb_15.csv',
                     row.names=FALSE,
                     quote=FALSE,
                     sep='\t')
